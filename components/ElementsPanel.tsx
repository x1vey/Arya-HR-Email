      ...
      <div className="grid grid-cols-2 gap-2">
        {LAYOUT_PRESETS.map((preset) => (
          <button
            ...
            className="group flex items-center gap-2 rounded-xl border border-slate-200 bg-white p-2.5 text-left transition hover:border-brand hover:shadow-panel"
          >
            <span
              className="flex h-8 w-8 shrink-0 items-center justify-center rounded-lg bg-slate-100 text-slate-500 transition group-hover:bg-brand group-hover:text-white [&_svg]:h-4 [&_svg]:w-4"
